        ...
        <div class="col-3">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body text-center">
                    <a href="pages/booking.php?pictures=<?= $pictures['nusantara'] ?>&reservations=<?= $reservations[0] ?>" class="btn btn-primary">Book now</a>
                </div>
            </div>
        </div>
        <div class="col-3">
            <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body text-center">
                        <a href="pages/booking.php?pictures=<?= $pictures['garuda'] ?>&reservations<?= $reservations[1] ?>" class="btn btn-primary">Book now</a>
                    </div>
                </div>
            </div>
        <div class="col-3">
            <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body text-center">
                        <a href="pages/booking.php?pictures=<?= $pictures['gsg'] ?>&reservations<?= $reservations[2] ?>" class="btn btn-primary">Book now</a>
                    </div>
                </div>
        </div>
  </div>
