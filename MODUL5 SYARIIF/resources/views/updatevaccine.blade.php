...
<div class="container pt-5 pb-5">
    <div class="row justify-content-center">
        <h4 class="text-center">Update Vaccine</h4>
        <div class="col-10">
            <form action="{{ route('updateVaccine',$vaccine->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                <!-- Vaccine Name -->
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('desccription') is-invalid @enderror" id="description"
                        name="description" rows="3" required>{{ old('description', $vaccine->description) }}</textarea>
                    @error('description')
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="file" id="img_path" name="img_path"
                        value="{{ old('img_path', $vaccine->img_path) }}" required>
                </div>
